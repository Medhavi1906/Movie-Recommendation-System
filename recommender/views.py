...
class MovieRecommender:
    ...
    def _load_models(self, progress_callback=None):
     """Load dummy model (temporary fix)"""
    ...
    # Dummy dataset
     self.metadata = pd.DataFrame({
        ...
        'vote_average': [8.8, 8.6, 9.0],
        'vote_count': [2000000, 1500000, 2300000],
        'release_date': ['2010', '2014', '2008'],
        'primary_company': ['Warner Bros', 'Paramount', 'Warner Bros'],
        'imdb_id': ['tt1375666', 'tt0816692', 'tt0468569'],
